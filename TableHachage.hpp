...
size_t TableHachage<TypeClef, TypeElement, FoncteurHachage>::_trouverPositionLibre(const TypeClef & p_clef)
{
    ...
    m_nCollisions += i;
    if (i > m_maximumCollisionUneInsertion) {
        m_maximumCollisionUneInsertion = i;
    }
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
bool TableHachage<TypeClef, TypeElement, FoncteurHachage>::contient(const TypeClef & p_clef) const
{
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
TypeElement TableHachage<TypeClef, TypeElement, FoncteurHachage>::element(const TypeClef & p_clef) const
{
    size_t position = _trouverPositionClef(p_clef);
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
void TableHachage<TypeClef, TypeElement, FoncteurHachage>::afficher(std::ostream & p_out) const
{
    p_out << "{";
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
void TableHachage<TypeClef, TypeElement, FoncteurHachage>::enlever(const TypeClef & p_clef)
{
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
size_t TableHachage<TypeClef, TypeElement, FoncteurHachage>::_trouverPositionClef(const TypeClef & p_clef) const
{
    size_t valeurHachee = _distribution(p_clef);
    size_t position = valeurHachee;
    long i(0);
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
size_t TableHachage<TypeClef, TypeElement, FoncteurHachage>::_distribution(const TypeClef & p_clef) const
{
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
bool TableHachage<TypeClef, TypeElement, FoncteurHachage>::_estVacante(size_t p_position) const
{
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
bool TableHachage<TypeClef, TypeElement, FoncteurHachage>::_estEffacee(size_t p_position) const
{
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
bool TableHachage<TypeClef, TypeElement, FoncteurHachage>::_estOccupee(size_t currentPos) const
{
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
bool TableHachage<TypeClef, TypeElement, FoncteurHachage>::_clefExiste(const size_t & p_position, const TypeClef & p_clef) const
{
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
void TableHachage<TypeClef, TypeElement, FoncteurHachage>::_reqEntreesActives(std::vector<EntreeHachage> & p_v) const
{
    for (size_t i = 0; i < m_tab.size(); ++i)
    {
        if (m_tab[i].m_info == OCCUPE)
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
int TableHachage<TypeClef, TypeElement, FoncteurHachage>::_prochainPremier(int p_entier) const
{
    if (p_entier % 2 == 0)
    {
        p_entier++;
 ...
 */
template<typename TypeClef, typename TypeElement, class FoncteurHachage>
bool TableHachage<TypeClef, TypeElement, FoncteurHachage>::_estPremier(int p_entier) const
{
    if (p_entier <= 1)
    {
        return false;
...
std::ostream& operator<<(std::ostream& p_out, const TableHachage<TClef, TElement, FHachage> & p_source)
{
